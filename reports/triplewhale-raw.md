...
| 字段名 | 类型 | 示例值 | 可空 |
|--------|------|--------|------|
| account_id | string | act_521260553647667 | 否 |
| ad_id | string | 120218387250470544 | 否 |
| ad_name | string | ERL001_Kraken 5000_230525PELAYX1_2_CC_sp_NL_230525PFON1_ | 否 |
| adset_id | string | 120218387250890544 | 否 |
| adset_name | string | 20250224_P_BJ-elaine_tf+bf_ASC_ERL001_Kraken 5000_test_3 | 否 |
| attribution_window | string | lifetime | 否 |
| billing_city | string | Statesville | 否 |
| billing_country | string | United States | 否 |
| billing_country_code | string | US | 否 |
| billing_province | string | North Carolina | 否 |
| browser | string | Mobile Safari | 否 |
| campaign_id | string | 120218387251350544 | 否 |
| campaign_name | string | 20250224_P_BJ-elaine_tf+bf_ASC_ERL001_Kraken 5000_test_3 | 否 |
| campaign_type | null |  | 是 |
| cancelled_at | null |  | 是 |
| channel | string | facebook-ads | 否 |
| click_date | string | 2025-07-04 | 否 |
| click_ts | string | 2025-07-04 14:44:26 | 否 |
| cogs | number | 0 | 否 |
| cost_of_goods | number | 0 | 否 |
| created_at | string | 2026-03-24 00:26:52 | 否 |
| currency | string | USD | 否 |
| currency_rate | number | 1 | 否 |
| custom_combined_gross_profit | number | 90.8 | 否 |
| custom_combined_gross_sales | number | 95.99 | 否 |
| custom_combined_net_revenue | number | 81.99 | 否 |
...
| customer_from_city | string | Statesville | 否 |
| customer_from_country_code | string | US | 否 |
| customer_from_country_name | string | United States | 否 |
| customer_from_state_code | string | NC | 否 |
| customer_id | string | 7339334860869 | 否 |
...
| discount_amount | number | 19.19 | 否 |
| discount_code | string | RC20 | 否 |
| discount_codes | array | [{'amount': 19.19, 'code': 'RC20', 'type': 'percentage'}] | 否 |
| event_date | string | 2026-03-24 | 否 |
| event_hour | number | 0 | 否 |
| financial_status | string | paid | 否 |
| fulfillment_status | string | fulfilled | 否 |
| gross_product_sales | number | 95.99 | 否 |
| gross_sales | number | 81.98999786376953 | 否 |
...
| landing_page | string | /cart | 否 |
| linear_weight | number | 1 | 否 |
| model | string | Triple Attribution | 否 |
| order_id | string | 6506265739333 | 否 |
| order_name | string | #298501 | 否 |
| order_revenue | number | 81.98999786376953 | 否 |
| orders_quantity | number | 1 | 否 |
| payment_gateway_costs | number | 0 | 否 |
| platform | string | shopify | 否 |
| product_quantity_sold_in_order | number | 1 | 否 |
| products_info | array | [{'product_id': '7595234459717', 'product_name': 'piscifun® chaos pro cnc baitcasting reel freshwater fishing', 'vendor': None, 'product_type': None, 'product_tags': [], 'product_sku': 'RL180-BK-50R-PN', 'variant_id': '42636051677253', 'product_name_price': 95.99, 'discount_amount_for_product': 0, 'net_discount_amount_for_product': 19.19, 'product_name_quantity_sold': 1, 'is_gift_card': False, 'single_product_cost': 0, 'properties': [], 'duties': []}] | 否 |
| refund_money | number | 0 | 否 |
| session_city | string | Red Bank | 否 |
| session_country | string | United States | 否 |
| session_id | string | cmmu0z2281IhTFz3Je_1774282170569 | 否 |
...
| tags | array | [''] | 否 |
| taxes | number | 5.19 | 否 |
| triple_id | string | cmmu0z2281IhTFz3Je | 否 |
| utm_medium | string | paid | 否 |
| utm_source | string | facebook | 否 |
...
| event_date | string | 2026-03-29 | 否 |
...
| channel | string | CartSee | 否 |
| city | string | Logansport | 否 |
...
| event_hour | number | 19 | 否 |
| is_new_visitor | boolean | False | 否 |
| keyword_id | string |  | 否 |
| landing_page | string | /collections/reels | 否 |
| ms_country | string |  | 否 |
| ms_country_name | string |  | 否 |
| session_elapsed_time | number | 93 | 否 |
| session_id | string | clqsczpur1WcotlPnN_1774609534701 | 否 |
| session_page_views | number | 3 | 否 |
| session_start_ts | string | 2026-03-27 11:05:34 | 否 |
| shop_id | string | piscifun.myshopify.com | 否 |
| shop_name | string | piscifun | 否 |
| source | string | CartSee | 否 |
| triple_id | string | clqsczpur1WcotlPnN | 否 |
| utm_medium | string | Email | 否 |
| utm_source | string | CartSee | 否 |

---

## 接口：product_analytics_tvf

**生成时间：** 2026-04-07 14:00:14

**样本记录数：** 1

| 字段名 | 类型 | 示例值 | 可空 |
|--------|------|--------|------|
| added_to_cart_events | number | 1 | 否 |
| added_to_cart_items | number | 1 | 否 |
| clicks | null |  | 是 |
...
| impressions | null |  | 是 |
| inventory_quantity | number | 199 | 否 |
...
**生成时间：** 2026-04-07 14:00:16

**样本记录数：** 1

| 字段名 | 类型 | 示例值 | 可空 |
|--------|------|--------|------|
| account_id | string | 141650153 | 否 |
| ad_study_cell_id | null |  | 是 |
| ad_study_end_date | null |  | 是 |
| ad_study_id | null |  | 是 |
| ad_study_integration_id | null |  | 是 |
...
| add_to_carts | null |  | 是 |
| addresses | null |  | 是 |
| adset_bid_amount | null |  | 是 |
| adset_bid_strategy | null |  | 是 |
| adset_id | string | 1331509449823057 | 否 |
| adset_name | string | Exact Match | 否 |
| adset_status | string | ACTIVE | 否 |
| attribution_window | string | lifetime | 否 |
| book_demos | null |  | 是 |
| bounces | null |  | 是 |
| campaign_bid_strategy | null |  | 是 |
| campaign_id | string | 418462397 | 否 |
| campaign_name | string | SA-Brand-EM-US | 否 |
| campaign_status | string | ACTIVE | 否 |
| channel | string | bing | 否 |
| channel_reported_all_conversions | number | 8 | 否 |
| channel_reported_conversion_value | number | 803.4099731445312 | 否 |
| channel_type | null |  | 是 |
| checkouts | null |  | 是 |
| click_orders | number | 0 | 否 |
| click_revenue | number | 0 | 否 |
...
| gross_product_sales | number | 0 | 否 |
| gross_sales | number | 0 | 否 |
| impressions | number | 101 | 否 |
| incremental_revenue_experiment | null |  | 是 |
| incremental_revenue_lower_bound_experiment | null |  | 是 |
| incremental_revenue_upper_bound_experiment | null |  | 是 |
| integration_id | string | 49ae05e1-2805-429d-a271-9f0a135753a1 | 否 |
| keyword_cpc_bid | null |  | 是 |
| keyword_effective_cpc_bid | null |  | 是 |
| keyword_id | string | 83219889321548 | 否 |
| keyword_match_type | string | Exact | 否 |
| keyword_quality_score | number | 10 | 否 |
| keyword_status | string | Active | 否 |
| keyword_system_serving_status | string |  | 否 |
| keyword_text | string | piscifun | 否 |
| leads | null |  | 是 |
| links | array | [] | 否 |
| marked_as_spam | null |  | 是 |
| message_subject | null |  | 是 |
...
| order_revenue | number | 0 | 否 |
| orders_quantity | number | 0 | 否 |
| original_provider_id | string | bing | 否 |
| payments | null |  | 是 |
| product_quantity_sold_in_order | number | 0 | 否 |
| provider_id | string | bing | 否 |
| received | null |  | 是 |
| recipients | null |  | 是 |
| refund_money | number | 0 | 否 |
| sent | null |  | 是 |
...
| shop_id | null |  | 是 |
| shop_name | null |  | 是 |
| spend | number | 65.43000030517578 | 否 |
| spend_experiment | null |  | 是 |
| sqls | null |  | 是 |
| subscribed_to_list | null |  | 是 |
| subscription_id_canceled_only_first | null |  | 是 |
...
| event_date | string | 2026-04-03 | 否 |
| event_hour | number | 0 | 否 |
| follows | number | 0 | 否 |
| i_revenue | null |  | 是 |
| i_roas | null |  | 是 |
