...
_DINGTALK_KOL_CONTENT = """CREATE TABLE IF NOT EXISTS hqware_test.ods_dingtalk_kol_tidwe_content (
    ...
    actual_publish_date DATE COMMENT '*实际发布日期',
    expected_publish_date DATE COMMENT '*预期发布日期',
...
_DINGTALK_RAW_MATERIAL = """CREATE TABLE IF NOT EXISTS hqware_test.ods_dingtalk_outdoor_raw_material (
    ...
    actual_completion_date DATE COMMENT '实际完成时间',
    ...
    actual_shipping_date DATE COMMENT '实际发货时间',
    ...
    expected_return_date DATE COMMENT '预期返回时间',
...
_DINGTALK_SHOOT_KOL = """CREATE TABLE IF NOT EXISTS hqware_test.ods_dingtalk_outdoor_shoot_kol (
    ...
    contract_date DATE COMMENT 'Contract Date-签合同时间',
...
_DINGTALK_VIDEO_DELIVERY = """CREATE TABLE IF NOT EXISTS hqware_test.ods_dingtalk_video_delivery (
    record_id VARCHAR(255) COMMENT '钉钉行ID (unique key)',
    completion_date DATE COMMENT '成片日期',
    product_spu VARCHAR(500) COMMENT '产品SPU',
...
_DINGTALK_MATERIAL_ANALYSIS = """CREATE TABLE IF NOT EXISTS hqware_test.ods_dingtalk_outdoor_material_analysis (
    record_id VARCHAR(255) COMMENT '行号 (unique key，普通表格无 recordId，用行号代替)',
...
CREATE_TABLES_SQL = [
    ...
    # 钉钉
    "DROP TABLE IF EXISTS hqware_test.ods_dingtalk_kol_tidwe_kol_info",
    "DROP TABLE IF EXISTS hqware_test.ods_dingtalk_kol_tidwe_sample",
    "DROP TABLE IF EXISTS hqware_test.ods_dingtalk_kol_tidwe_content",
    "DROP TABLE IF EXISTS hqware_test.ods_dingtalk_outdoor_raw_material",
    "DROP TABLE IF EXISTS hqware_test.ods_dingtalk_outdoor_shoot_kol",
    "DROP TABLE IF EXISTS hqware_test.ods_dingtalk_video_delivery",
    "DROP TABLE IF EXISTS hqware_test.ods_dingtalk_outdoor_material_analysis",
    "DROP TABLE IF EXISTS hqware_test.ods_dingtalk_outdoor_params",
    _DINGTALK_KOL_INFO,
